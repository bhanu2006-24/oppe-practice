...
`,
    ...
    },
    {
        ...
        examples: [{ input: '', output: '1|Alice|' }],
        starterCode: `CREATE TABLE users (id INT, name TEXT); INSERT INTO users VALUES (1, 'Alice');
...
`,
    ...
    },
    {
        ...
        starterCode: `CREATE TABLE temp (id INT);
-- Write your query below
`,
        functionName: 'sql',
    ...
    },
    {
        ...
        examples: [{ input: '', output: '0' }],
        starterCode: `CREATE TABLE logs (msg TEXT); INSERT INTO logs VALUES ('Error');
-- Write your query below
DELETE FROM logs;
...
`,
    ...
    },
    {
        ...
        examples: [{ input: '', output: '1\n2' }],
        starterCode: `CREATE TABLE A (val INT); CREATE TABLE B (val INT);
...
`,
    ...
    },
    {
        ...
        starterCode: `CREATE TABLE users (id INT, name TEXT); CREATE TABLE orders (user_id INT);
...
`,
    ...
    },
    {
        ...
        examples: [{ input: '', output: 'Alice' }],
        starterCode: `CREATE TABLE users (name TEXT); INSERT INTO users VALUES ('Alice');
-- Write your query below
`,
        functionName: 'sql',
        testCases: [{ input: '', expected: 'Alice' }],
    ...
    },
    {
        ...
        examples: [{ input: '', output: '' }],
        starterCode: `CREATE TABLE users (email TEXT);
-- Write your query below
`,
        functionName: 'sql',
        testCases: [{ input: '', expected: '' }],
...
`,
    ...
    },
    {
        ...
        examples: [{ input: '', output: 'Alice' }],
        starterCode: `CREATE TABLE users (name TEXT); INSERT INTO users VALUES ('Alice'), ('Bob');
-- Write your query below
`,
        functionName: 'sql',
        testCases: [{ input: '', expected: 'Alice' }],
...
`,
    ...
    },
    {
        ...
        examples: [{ input: '', output: '2' }],
        starterCode: `CREATE TABLE T (val INT); INSERT INTO T VALUES (1), (2), (3);
-- Write your query below
`,
        functionName: 'sql',
        testCases: [{ input: '', expected: '2' }],
    ...
    },
    {
        ...
        examples: [{ input: '', output: '' }],
        starterCode: `CREATE TABLE T (val INT); INSERT INTO T VALUES (NULL);
-- Write your query below
...
`,
    ...
    },
    {
        ...
        examples: [{ input: '', output: '2' }],
        starterCode: `CREATE TABLE T (val INT); INSERT INTO T VALUES (0), (2), (4);
-- Write your query below
`,
        functionName: 'sql',
        testCases: [{ input: '', expected: '2' }],

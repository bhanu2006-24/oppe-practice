...
export const Home: React.FC<HomeProps> = ({ 
  ...
  const courses: Course[] = [
    ...
    },
    {
      ...
      level: 'Diploma',
      description: 'Object Oriented Programming. (Coming Soon)',
      icon: BookOpen,
      color: 'orange',
      available: false
    },
    {
      ...
      level: 'Diploma',
      description: 'Linux/Bash Scripting. (Coming Soon)',
      icon: Terminal,
      color: 'slate',
      available: false
    },
  ...
  const LevelButton = ({ level, label }: { level: Level, label: string }) => {
    ...
    return (
      <button
        ...
        className={`flex items-center px-5 py-3 rounded-lg font-bold text-sm transition-all duration-200 ${
          isActive 

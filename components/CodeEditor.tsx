  ...
  return (
    <div className="relative flex h-full w-full bg-slate-50 dark:bg-[#1e1e1e] font-mono text-sm overflow-hidden transition-colors duration-200">
      ...
      <textarea
        ...
        className="flex-1 bg-transparent text-slate-800 dark:text-slate-200 p-4 pt-4 outline-none resize-none whitespace-pre border-none leading-6 editor-font custom-scrollbar"
        spellCheck={false}
        autoCapitalize="off"
        autoComplete="off"
        autoCorrect="off"

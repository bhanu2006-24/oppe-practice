...
import { CheckCircle, Circle, ArrowLeft, Terminal, LayoutList, CheckSquare, Search } from 'lucide-react';
          ...
          filteredProblems.map((problem, index) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-start p-3 rounded-lg text-sm transition-all border ${
                  isSelected 
